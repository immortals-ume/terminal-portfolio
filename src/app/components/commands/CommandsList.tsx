  ...
  const commandCategories = [
    {
      ...
      commands: [
        ...
        { cmd: "skills", desc: "Technical skills and expertise", aliases: ["show skills"] },
    ...
    {
      category: "🏆 Achievements & Stats",
      commands: [
        { cmd: "certifications", desc: "Professional certifications", aliases: ["certs", "badges", "credentials"] },
        { cmd: "github", desc: "GitHub profile statistics", aliases: ["gh", "git"] },
      ]
    },
    {
      ...
      commands: [
        ...
        { cmd: "theme [1-7]", desc: "Quick theme selection (e.g., 'theme 2')", aliases: [] },
    ...
    },
    {
      ...
      commands: [
        { cmd: "system", desc: "Show system information", aliases: [] },
  ...
  return (
    <div>
      <div style={{ marginBottom: "20px" }}>
        <strong>🖥️ Kapil's Terminal Portfolio</strong>
      </div>
